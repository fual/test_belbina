...
const roles: any = {
    ...
    "Оценщик": {
        ...
        image: ozenchik,
        description: 'Рассудителен, проницателен, обладает стратегическим мышлением. Видит все альтернативы, все взвешивает — инспектор. Аналитик-стратег (Оценщик) объективен при анализе проблем и оценке идей. Редко охваченный энтузиазмом, он защищает команду от принятия импульсивных, отчаянных решений. Представители этой роли ярко не проявляют себя в команде до тех пор, пока не приходит время принятия важных решений'
    },
    "Коллективист": {
        ...
        image: collectivist,
        description: 'Мягкий, восприимчивый, дипломатичный. Умеет слушать, предотвращает трения членов команды — чувствителен по отношению и к индивидам, и к ситуациям. Душа команды (он же Коллективист) играет ориентированную на отношения, поддерживающую роль в команде'
    },
    "Исполнитель": {
